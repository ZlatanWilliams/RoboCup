"""
Red Team Left Forward robot behaviours.
"""
...
class ForwardLeft(SoccerRobot):
    ...
    def decideMotion(self, ballCoordinate, selfCoordinate):
        ...
        if bodyDistanceFromBall < 0.25:
            turningAngleForGoal = Functions.calculateTurningAngleAccordingToRobotHeading(RedTeamStrategies.BLUE_GOAL["Right"], selfCoordinate, robotHeadingAngle)
